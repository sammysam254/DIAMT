...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        <title>XML Sitemap — DIAMT Device Rentals</title>
        <meta charset="UTF-8"/>
      ...
      <body>
        <div class="container">
          ...
          <p>This XML sitemap lists public URLs available for search engine indexing on DIAMT Device Rentals Marketplace.</p>
          <table>
            <thead>
              <tr>
                <th>URL</th>
